...
inicio
       movlw   B'11000000' ; Binary number 01010101 is written to W
       ...
       call	  retardo
       call	  retardo
       movlw   B'00110000' ; Binary number 01010101 is written to W
       movwf   PORTB    	   ; Number is moved to PORTB
       movlw   h'FF'  		   ; Number hFF is moved to W
       movwf   counter 	   ; Number is moved to variable "counter1"
       call	  retardo
       call	  retardo
       movlw   B'00001100' ; Binary number 01010101 is written to W
       movwf   PORTB    	   ; Number is moved to PORTB
       movlw   h'FF'  		   ; Number hFF is moved to W
       movwf   counter 	   ; Number is moved to variable "counter1"
       call	  retardo
       call	  retardo
       movlw   B'00000011' ; Binary number 10101010 is moved to W
       movwf   PORTB   	   ; Number is moved to PORTB
       movlw   h'FF'     	   ; Number hFF is moved to W
       movwf   counter   	   ; Number is moved to variable "counter1"
       call        retardo
